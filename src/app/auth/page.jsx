...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-6">
      ...
      >
        <h1 className="mb-2 text-3xl font-bold text-white">Entrar no Gameplex</h1>
        <p className="mb-8 text-sm text-zinc-500">Acesse para salvar favoritos e acompanhar seu histórico.</p>
        ...
        <p className="mt-8 text-sm text-zinc-500 text-center">
          Jogue sem login. Entre apenas para salvar favoritos e histórico.
        </p>
      </motion.div>
    </div>
  );
