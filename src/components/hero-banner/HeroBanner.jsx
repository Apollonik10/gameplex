      ...
      <div className="relative z-10 flex h-full flex-col justify-center px-6 md:px-16 lg:w-1/2">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 rounded bg-white px-8 py-2.5 text-black transition hover:bg-zinc-200">
              <Play className="fill-current" size={24} />
              <span className="font-bold uppercase tracking-wide text-sm">Assistir Trailer</span>
            </button>
            <button className="flex items-center gap-2 rounded bg-zinc-500/50 px-8 py-2.5 text-white backdrop-blur-md transition hover:bg-zinc-500/70">
              <Info size={24} />
